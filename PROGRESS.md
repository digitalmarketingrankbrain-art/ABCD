...
| 4 | Homepage | Delivered — awaiting approval | All 10 Phase 5 sections built in `src/components/home/`; placeholder data in `src/lib/programs.ts` / `src/lib/news.ts`. Build/typecheck/lint clean, all sections verified present in rendered HTML. |
