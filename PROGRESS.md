...
| 3 | Public layout (header/footer/nav shell) | Delivered — awaiting approval | Header (mega menu, mobile nav) + Footer built in `src/components/layout/`, wired via a `(public)` route group. Build/typecheck/lint clean, dev-server verified. |
