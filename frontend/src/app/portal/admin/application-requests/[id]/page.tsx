...
import { REQUEST_STATUS_LABEL, REQUEST_STATUS_TONE } from "@/components/portal/admin-application-requests-table";
import { getApplicationRequest } from "@/lib/portal/application-requests-data";

const APPLY_FOR_LABEL: Record<string, string> = {
...
export default async function AdminApplicationRequestDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="px-6 py-8">
      <Breadcrumbs
        items={[
          { label: "Application Requests", href: "/portal/admin/application-requests" },
