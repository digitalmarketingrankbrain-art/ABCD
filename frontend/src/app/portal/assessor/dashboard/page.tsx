    ...
    <div className="px-6 py-8">
      ...
      {pending.length > 0 && (
        <div className="mt-6 flex flex-col gap-3">
          {pending.map((a) => (
            <Link
              key={a.id}
              href={`/portal/assessor/assignments/${a.id}`}
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <Card>
          ...
          <CardFooter>
            <Link href="/portal/assessor/assignments" className="text-sm font-medium text-secondary hover:underline">
              View all →
            </Link>
          </CardFooter>
        </Card>
          ...
          <CardContent>
            {awaitingReport.length === 0 ? (
              ...
              awaitingReport.map((a) => (
                <Link key={a.id} href={`/portal/assessor/assignments/${a.id}`} className="block text-sm text-secondary hover:underline">
        ...
        <Card>
          ...
          <CardFooter>
            <Link href="/portal/assessor/competence" className="text-sm font-medium text-secondary hover:underline">
              View competence →
            </Link>
          </CardFooter>
        </Card>
