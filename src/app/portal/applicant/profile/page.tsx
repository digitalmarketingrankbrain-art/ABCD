    ...
    <div className="max-w-md px-6 py-8">
      ...
      <form className="mt-6 flex flex-col gap-5">
        <FormField label="Organisation name" htmlFor="org">
          <Input id="org" defaultValue={user?.organisationName} disabled />
        </FormField>
        ...
        <p className="font-sans text-xs text-text-muted">
          [PLACEHOLDER — profile editing wired up once the real Organisation/User tables land in Milestone 11.]
        </p>
